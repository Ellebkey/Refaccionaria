...
class AcquisitionsControllerTest < ActionController::TestCase
  ...
  test "should create acquisition" do
    assert_difference('Acquisition.count') do
      post :create, acquisition: { buy_id: @acquisition.buy_id, cant: @acquisition.cant, product_id: @acquisition.product_id }
    end
  ...
  test "should update acquisition" do
    patch :update, id: @acquisition, acquisition: { buy_id: @acquisition.buy_id, cant: @acquisition.cant, product_id: @acquisition.product_id }
    assert_redirected_to acquisition_path(assigns(:acquisition))
  end
