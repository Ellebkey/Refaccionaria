...
class FacturesControllerTest < ActionController::TestCase
  ...
  test "should create facture" do
    assert_difference('Facture.count') do
      post :create, facture: { client_id: @facture.client_id, fecha: @facture.fecha, totalfac: @facture.totalfac }
    end
  ...
  test "should update facture" do
    patch :update, id: @facture, facture: { client_id: @facture.client_id, fecha: @facture.fecha, totalfac: @facture.totalfac }
    assert_redirected_to facture_path(assigns(:facture))
  end
