...
class BuysControllerTest < ActionController::TestCase
  ...
  test "should create buy" do
    assert_difference('Buy.count') do
      post :create, buy: { admin_user_id: @buy.admin_user_id, fecha: @buy.fecha, provider_id: @buy.provider_id, total: @buy.total }
    end
  ...
  test "should update buy" do
    patch :update, id: @buy, buy: { admin_user_id: @buy.admin_user_id, fecha: @buy.fecha, provider_id: @buy.provider_id, total: @buy.total }
    assert_redirected_to buy_path(assigns(:buy))
  end
