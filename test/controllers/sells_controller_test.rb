...
class SellsControllerTest < ActionController::TestCase
  ...
  test "should create sell" do
    assert_difference('Sell.count') do
      post :create, sell: { cant: @sell.cant, facture_id: @sell.facture_id, product_id: @sell.product_id, state: @sell.state, totalp: @sell.totalp }
    end
  ...
  test "should update sell" do
    patch :update, id: @sell, sell: { cant: @sell.cant, facture_id: @sell.facture_id, product_id: @sell.product_id, state: @sell.state, totalp: @sell.totalp }
    assert_redirected_to sell_path(assigns(:sell))
  end
